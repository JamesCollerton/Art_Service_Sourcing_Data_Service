...
/**
 * Utilities class for all functionality around using '{@link Iterable}'.
 */
public class IterableUtilities {

    /**
     * Used to convert an '{@link Iterable} of one type into a list of another type (under the restriction
